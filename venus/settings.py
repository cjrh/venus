...
ZMQ_TCP_KEEPALIVE = environ.get('ZMQ_TCP_KEEPALIVE', 1)
ZMQ_TCP_KEEPALIVE_IDLE = environ.get('ZMQ_TCP_KEEPALIVE_IDLE', 300)
ZMQ_TCP_KEEPALIVE_INTVL = environ.get('ZMQ_TCP_KEEPALIVE_INTVL', 300)

ZMQ_HEARTBEAT_IVL_SLAMR = environ.get('ZMQ_HEARTBEAT_IVL_SLAMR', 3000)  # 3 seconds
ZMQ_HEARTBEAT_TIMEOUT_SLAMR = environ.get('ZMQ_HEARTBEAT_TIMEOUT_SLAMR', 30000)  # 30 seconds
ZMQ_HEARTBEAT_TTL_SLAMR = environ.get('ZMQ_HEARTBEAT_TTL_SLAMR', 30000)  # 30 seconds

ZMQ_HEARTBEAT_IVL_SLICR = environ.get('ZMQ_HEARTBEAT_IVL_SLICR', 3000)  # 3 seconds
ZMQ_HEARTBEAT_TIMEOUT_SLICR = environ.get('ZMQ_HEARTBEAT_TIMEOUT_SLICR', 30000)  # 30 seconds
ZMQ_HEARTBEAT_TTL_SLICR = environ.get('ZMQ_HEARTBEAT_TTL_SLICR', 30000)  # 30 seconds

VENUS_PORT = environ.get('VENUS_PORT', 56119)
